...
os.system('clear')
psb('\x1b[1;32mBANGLADESH MOHAMMAD 11 DIGIT CLONING START PLEASE WAIT ..........')
for n in range(9999):
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : MOHAMMAD'
    print 'FACEBOOK : facebook.com/md.sentu.16906'
    print 'GITHUB     : github.com/MOHAMMAD'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
